report 50121 "Create Seminar Invoices"
{
    ...
    local procedure SetFieldsOnSalesLine(SeminarLedgerEntry: Record "Seminar Ledger Entry");
    var
    ...
    local procedure SetNoOnSalesLine(SeminarLedgerEntry: Record "Seminar Ledger Entry");
    begin
