...
codeunit 50104 "Seminar-Post"
{
    ...
    procedure CopyCommentLines(FromDocumentType: Enum "Seminar Document Type"; ToDocumentType: Enum "Seminar Document Type"; FromNumber: Code[20]; ToNumber: Code[20])
    var 
        SeminarCommentLine: Record "Seminar Comment Line";
    ...
    procedure CopyCharges(FromNumber: Code[20]; ToNumber: Code[20])
    var
        SeminarCharge: Record "Seminar Charge";
    ...
    procedure PostSeminarJnlLine(var ChargeType: Enum "Seminar Journal Charge Type") 
    begin
        with SemRegHeader do begin
            SeminarJnlLine.INIT; 
    ...
    procedure PostCharges(ChargeType: Enum "Seminar Journal Charge Type")
    begin
        SeminarCharge.Reset;
    ...
    var 
        LineCount: Integer;
        ChargeType: Enum "Seminar Journal Charge Type";
    begin
        ClearAll;
        SemRegHeader := Rec;
        with SemRegHeader do begin
            ...
            Window.OPEN( 
                '#1#################################\\' + 
                'Posting lines              #2######\'); 
            Window.UPDATE(1,STRSUBSTNO('%1 %2','Registration',"No."));
            ...
            Window.UPDATE(1,STRSUBSTNO('Registration %1  -> Posted Reg. %2',"No.", PstdSeminarRegHeader."No."));
            ...
            IF SeminarRegLine.FINDSET THEN BEGIN 
                ...
                PostCharges(ChargeType); 
                
                // Post instructor to seminar ledger 
                ChargeType := ChargeType::Instructor;
                PostSeminarJnlLine(ChargeType);
